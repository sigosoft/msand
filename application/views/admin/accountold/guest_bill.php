                                                          ...
                                                          <!--<div class="form-group m-b-25 clearfix">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                      ...
                                                                      <div class="col-12 fl">
                                                                          ...
                                                                          <input type="text" class="form-control"   name="balance"  id="balance"   onclick="show_customer();">
                                                                      </div>
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                      ...
                                                                      <div class="form-group m-b-25 clearfix">
                                                                              ...
                                                                              <div class="col-4 fl">
                                                                                  <label for="notes" ><b>Price</b></label>
                                                                          ...
                                                                          <div class="form-group m-b-25 clearfix">
                                                                              ...
                                                                              <div class="form-group m-b-25 clearfix">
                                                                                  ...
                                                                                  <div class="form-group m-b-25 clearfix">
                                                                                          ...
                                                                                          <input type="text" class="form-control"   name="discount" id="discount" value="<?php echo "0"; ?>"  oninput="show_amount();">
                                                                                              </div>
                                                                                              <div class="col-6 fl">
                                                                                      ...
                                                                                      <div class="form-group m-b-25 clearfix">
                                                                                              <div class="col-12 fl">
                                                                                                ...
                                                                                                <input type="text" class="form-control"   name="cash_recieved" id="cash_recieved" required oninput="show_bal_amount();">
                                                                                              </div>
                                                                                      </div>
                                                                                      ...
                                                                                      <div class="form-group m-b-25 clearfix">
                                                                                              ...
                                                                                              <input type="text" class="form-control"   name="balance1" id="balance1" required readonly>
                                                                                                  </div>
...
function calc_total(){
  ...
  //document.getElementById("cash_recieved").value = tot;
