                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <!-- end row -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/Account/raw_material/do_add" method="post">
                                ...
                                <input type="hidden" class="form-control" data-toggle="password"  name="price" id="price" required >
                                                                              ...
                                                                              <!--<div class="col-4 fl">
                                                                                  ...
                                                                                  <input type="text" class="form-control" data-toggle="password"  name="price" id="price" required >
