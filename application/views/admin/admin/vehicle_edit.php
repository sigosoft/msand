                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Edit Vehicle</h4></span>
                                            </h2>

                                            <?php foreach($vehicle as $row){ ?>
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/vehicle/update/<?php echo $row['vehicle_id'] ;?>" method="post">
                                                ...
                                                <div class="form-group m-b-25">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" rows="5" name="model" value="<?php echo $row['model']; ?>">
                                                    ...
                                                    <div class="form-group m-b-25">
                                                            <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control" rows="5" name="reg" value="<?php echo $row['reg_number']; ?>">
                                                       ...
                                                       <label for="notes"><b>Company Body</b></label>
                                                        <div class="form-group m-b-25 clearfix">
                                                          <div class="col-2 fl">
                                                              ...
                                                              <input type="text" class="form-control" rows="5" name="cl" id="cl" value="<?php echo $row['cl']; ?>" required>
                                                          </div>
                                                          <div class="col-1 fl">
                                                          ...
                                                          <div class="col-2 fl">
                                                              ...
                                                              <input type="text" class="form-control" rows="5" name="cw" id="cw" value="<?php echo $row['cw']; ?>" required>
                                                          </div>
                                                          <div class="col-1 fl">
                                                              <label for="notes"></label>
                                                              &#x2715;
                                                          ...
                                                          <div class="col-2 fl">
                                                              ...
                                                              <input type="text" class="form-control" rows="5" name="ch" id="ch" value="<?php echo $row['ch']; ?>" oninput="show_total();" required>
                                                          </div>
                                                          <div class="col-2 fl">
                                                              <label for="notes">Total</label>
                                                              <input type="text" class="form-control" rows="5" name="tl1" id="tl" value="<?php echo $row['company_body_actual']; ?>" required>
                                                          </div>
                                                          <div class="col-2 fl">
                                                              <label for="notes">=</label>
                                                              <input type="text" class="form-control" rows="5" name="ml1" id="ml" value="<?php echo $row['company_body_manual']; ?>">
                                                          </div>
                                                            </div>
                                                            ...
                                                            <label for="notes"><b>Extra Body(Optional)</b></label>
                                                             <div class="form-group m-b-25 clearfix">
                                                               ...
                                                               <div class="col-2 fl">
                                                                   <label for="notes">Length</label>
                                                                   <input type="text" class="form-control" rows="5" name="el" id="el" value="<?php echo $row['el']; ?>">
                                                               </div>
                                                               <div class="col-1 fl">
                                                                 <label for="notes"></label>
                                                                 &#x2715;
                                                               ...
                                                               <div class="col-2 fl">
                                                                   <label for="notes">Width</label>
                                                                   <input type="text" class="form-control" rows="5" name="ew" id="ew" value="<?php echo $row['ew']; ?>">
                                                               </div>
                                                               <div class="col-1 fl">
                                                                   <label for="notes"></label>
                                                                   &#x2715;
                                                               ...
                                                               <div class="col-2 fl">
                                                                   <label for="notes">Height</label>
                                                                   <input type="text" class="form-control" rows="5" name="eh" id="eh" oninput="show_tot();" value="<?php echo $row['eh']; ?>">
                                                               </div>
                                                               <div class="col-2 fl">
                                                                   <label for="notes">Total</label>
                                                                   <input type="text" class="form-control" rows="5" name="tle" id="tle" value="<?php echo $row['extra_body_actual']; ?>">
                                                               </div>
                                                               <div class="col-2 fl">
                                                                   <label for="notes">=</label>
                                                                   <input type="text" class="form-control" rows="5" name="mle" id="mle" value="<?php echo $row['extra_body_manual']; ?>">
                                                               </div>
                                                             </div>
