                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Raw Materials</h4>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Raw Material</h4></span>
                                            </h2>


                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/raw_materials/add" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>index.php/main_admin/raw_materials/edit/<?php echo $row['raw_material_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                    <!--<td><a href="<?php echo base_url(); ?>index.php/main_admin/raw_materials/delete/<?php echo $row['raw_material_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>-->
                                </tr>
                              <?php $i++;} ?>
                                </tbody>
                            </table>
