                  ...
                  <div class="row">
                      <div class="col-12">
                          <div class="page-title-box">
                              <h4 class="page-title float-left">Daily Cash Transaction</h4>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <?php 
									$d=date('Y-m-d');
									$r=$this->db->get_where('cash_report',array('date'=>$d))->row()->opening; 
									
									?>
									<tr>
                                        <td colspan="6">Opening Balance  :  <?php echo $r; ?></td>
                                    </tr>
                                      <th>No</th>
                                      <th>Time</th>
                                      <th>Invoice No</th>
                                  ...
                                  <?php $i++;} ?>
                                    ...
                                    <tr><td></td><td></td><td></td><td><b>TOTAL</b></b></td><td><b><?php echo ($sum1); ?></b></td><td ><b><?php echo ($sum); ?></b></td></tr>
                                    
                                    
                                    <?php 
									$d=date('Y-m-d');
									$r=$this->db->get_where('cash_report',array('date'=>$d))->row()->closing; 
									
									?>
									<tr>
                                        <td colspan="6">Closing Balance  :  <?php echo $r; ?></td>
                                    </tr>
                                </table>
                                    </div>
                                </div>
