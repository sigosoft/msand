                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div id="cust1" >
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/cash_in/do_add" method="post">
                                          ...
                                          <form class="form-horizontal " action="<?php echo base_url(); ?>index.php/main_admin/cash_in/vendor_do_add" method="post">
