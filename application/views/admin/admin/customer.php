                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/customer/do_add" method="post">
                                              <div class="form-group m-b-25 clearfix">
                                                <div class="col-12">
                                                      ...
                                                      <div class="col-6 fl">
                                                        ...
                                                        <input type="number" class="form-control" rows="5" name="ob" >
                                                      </div>
