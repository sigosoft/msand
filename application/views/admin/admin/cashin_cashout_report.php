                            ...
                            <div class="row">
                                <div class="col-12">
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="<?php echo base_url();?>index.php/main_admin/status_cancel_cash_in/<?php echo $row['LedgerID']; ?>"><i class="fa fa-remove" style="font-size:24px;color:red"></i></a></td>
