                                ...
                                <div class="col-12">
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $row['invoice_no']; ?></td>
                                      <td><?php echo $this->db->get_where('product',array('id'=>$row['product']))->row()->name; ?></td>
                                      
                                      <?php if($row['customer']==0){ ?>
                                    <td> <?php echo "Guest - ".$row['customer_name']; ?></td>
                                    <?php } else { ?>
                                    <td><?php echo $this->db->get_where('customer',array('id'=>$row['customer']))->row()->name; ?></td>
                                    <?php } ?>
                                      ...
                                      <td><a href="<?php echo base_url();?>index.php/main_admin/status_cancel_sales/<?php echo $row['sales_id']; ?>"><i class="fa fa-remove" style="font-size:24px;color:red"></i></a></td>
                                      <?php } else {?>
                                    <td>Cancelled</a></td>
                                    <?php } ?>
