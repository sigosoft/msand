...
<body onload="test()">
	<section>
		<page size="A4">
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
            <?php $res = $this->db->get_where('raw_material_print',array('raw_print_id'=>$id))->result_array();
                  foreach($res as $row){
            ?>
						<p class="col-4">No</p> <p class="col-3">:</p><p class="col-4"><strong><?php echo $row['raw_invoice_no']; ?></strong></p>
            ...
            <p class="col-4">Reg.No</p> <p class="col-3">:</p> <p class="col-4"><strong><?php echo $row['vehicle']; ?></strong></p>
						<h3 class="col-8 text-center pt20"><b><?php echo $this->db->get_where('raw_material',array('raw_material_id'=>$row['product']))->row()->raw_material_name; ?></b></h3>
            <h3 class="col-8 text-center"><b><?php echo $row['quantity']; ?></b></h3>
  ...
  window.print();
  window.location.href = "<?php echo base_url(); ?>index.php/main_admin/raw_material";
}
