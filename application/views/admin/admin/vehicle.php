                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Vehicle</h4>
                                    ...
                                    <ol class="breadcrumb float-right">
                                       ...
                                       <a href="<?php echo base_url(); ?>index.php/main_admin/vehicle/add"><button type="button" class="btn btn-gradient btn-rounded waves-light waves-effect w-md">Add Vehicle</button></a>
                                    </ol>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/vehicle/add" method="post">
                                ...
                                <div class="col-12">
                                    ...
                                    <tr>
                                      ...
                                      <?php echo $row['ch']; ?></td>
                                        ...
                                        <td><a href="<?php echo base_url(); ?>index.php/main_admin/vehicle/edit/<?php echo $row['vehicle_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                        <td><a href="<?php echo base_url(); ?>index.php/main_admin/vehicle/delete/<?php echo $row['vehicle_id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                    </tr>
                                  <?php $i++;} ?>
                                    </tbody>
                                </table>
