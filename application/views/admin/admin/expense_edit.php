                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/expense/update/<?php echo $row['expense_id'] ;?>" method="post">


											                    	<div class="form-group m-b-25">
                                                    <div class="col-12">
                                                        <label for="notes"> Name</label>
                                                        <input type="text" class="form-control" rows="5" name="name" value="<?php echo $row['expense_name']; ?>">
                                                ...
                                                <div class="form-group m-b-25">
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-control" rows="5" name="category">
                                                              <?php $r= $this->db->get_where('expense_category')->result_array();
                                                                foreach($r as $res){
                                                              ?>
                                                              <option <?php if($res['exp_catid'] == $row['category'] ) { echo "selected='selected'"; }  ?> value="<?php echo $res['exp_catid'] ?>"><?php echo $res['name'] ?></option>
                                                            <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="form-group m-b-25">
                                                            <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control" rows="5" name="amount" value="<?php echo $row['amount']; ?>">
                                                    ...
                                                    <div class="form-group m-b-25">
                                                            <div class="col-12">
                                                                ...
                                                                <textarea class="form-control" rows="5" name="notes"><?php echo $row['description']; ?></textarea>
                                                        ...
                                                        <div class="form-group m-b-25">
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="date" class="form-control" rows="5" name="date" value="<?php echo $row['date']; ?>">
