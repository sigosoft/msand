                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Add Customers</h4></span>
                                            </h2>

<?php foreach($customer as $row) { ?>
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/customer/update/<?php echo $row['id']; ?>" method="post">
                                              <div class="form-group m-b-25 clearfix">
                                                <div class="col-12">
                                                      <div class="col-6 fl">
                                                        <label for="notes">Date</label>
                                                        <input type="date" class="form-control" rows="5" name="date" value="<?php echo $row['insert_date']; ?>" required >
                                                      ...
                                                      <div class="col-6 fl">
                                                        ...
                                                        <input type="text" class="form-control" rows="5" name="name" required value="<?php echo $row['name']; ?>">
                                                      </div>
                                                      </div>
                                                        </div>
                                                      <div class="form-group m-b-25 clearfix">
                                                      ...
                                                      <div class="col-6 fl">
                                                        ...
                                                        <input type="text" class="form-control" rows="5" name="mobile" required value="<?php echo $row['phone']; ?>">
                                                      </div>

                                                      <div class="col-6 fl">
                                                        <label for="notes">Opening Balance </label>
                                                        <input type="number" class="form-control" rows="5" name="ob" value="<?php echo $row['ob']; ?>">
                                                      </div>
...
<br><br>
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/main_admin/customer"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
...
//alert("adsdsdsdfsdf");
     ...
     logid=document.getElementById("logid").value;
       //alert(name);alert(price);alert(logid);

if(name=='' || price=='' ){alert('Please Fill All The Fields');}
else{
   object=new XMLHttpRequest();

     ur="<?php echo base_url();?>index.php/main_admin/addcustomerproducts/"+name+"/"+price+"/"+logid;
...
$.ajax({url: '<?php echo base_url(); ?>index.php/Main_admin/add_customer_price/'+name, success: function(result){
...
function deletecustomer_products(delid)
{
	  ...
	  /* alert(item);
       ...
       ur="<?php echo base_url();?>index.php/Main_admin/deletecustomer_products/"+delid+"/"+logid;
