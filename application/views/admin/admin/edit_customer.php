...
<head>
    ...
    <body>
                                ...
                                <div class="col-12">
                                  ...
                                  <td>
                                      <select class="form-control" id="name<?php echo $i; ?>" name="name<?php echo $i; ?>">
                                          <?php $resss =  $this->db->get('product')->result_array(); 
                                          foreach($resss as $ress2){?>
                                          
                                          <option value="<?=$ress2['id']?>" <?php if($row['prod_name'] ==  $ress2['id']){echo "selected";} ?>><?=$ress2['name']?></option>
                                  ...
                                  <input type="hidden" value="<?php echo $row['prod_id']; ?>" id="prod<?php echo $i; ?>" name="prod<?php echo $i; ?>" style="width:70px">
                                  </td>
        ...
        $.ajax({
        url: '<?php echo base_url();?>index.php/Main_admin/customer_update/'+name+"/"+price+"/"+prod_id,
        type:'POST',
        //contentType: 'application/json',
        dataType: 'text',
        success: function(result){
