                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/raw_materials/update/<?php echo $row['raw_material_id'] ;?>" method="post">


											                    	<div class="form-group m-b-25">
                                                    <div class="col-12">
                                                        <label for="notes"> Name</label>
                                                        <input type="text" class="form-control" rows="5" name="name" value="<?php echo $row['raw_material_name']; ?>">
                                                ...
                                                <div class="form-group m-b-25">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" rows="5" name="price" value="<?php echo $row['price']; ?>">
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/main_admin/raw_materials"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
