                                ...
                                <div class="col-12">
                                  ...
                                  <th>Edit Vendor</th>
                                   ...
                                   $i=1;
                                    ...
                                    <tr>
                                  <td><?php echo $i; ?></td>
                                  <td><?php echo $row['vendor_add_date']; ?></td>
                                  ...
                                  <td><a href="#"  onclick="pro_view(this,'<?php echo $row['vendor_id']; ?>')"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                  <td><a href="<?php echo base_url(); ?>index.php/main_admin/vendor/edit/<?php echo $row['vendor_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                  <td><a href="<?php echo base_url(); ?>index.php/main_admin/vendor/edit_vendor/<?php echo $row['vendor_id']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                                  <!--<td><a href="<?php echo base_url(); ?>index.php/main_admin/vendor/edit/<?php echo $row['vendor_id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>-->
