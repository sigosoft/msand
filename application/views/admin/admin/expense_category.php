                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb float-right">
                                       <button type="button" class="btn btn-gradient btn-rounded waves-light waves-effect w-md"  data-toggle="modal" data-target="#add-record">Add Expense Category</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Expense Category</h4></span>
                                            </h2>


                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/expense_category/add" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                //$product= $this->db->get('product')->result_array();
                                  ...
                                  foreach($exp_cate as $row){ ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $row['name']; ?></td>
                                    <td><?php echo $row['notes']; ?></td>
                                    <td><a href="<?php echo base_url(); ?>index.php/main_admin/expense_category/edit/<?php echo $row['exp_catid']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                    <!--<td><a href="<?php echo base_url(); ?>index.php/main_admin/expense_category/delete/<?php echo $row['exp_catid']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>-->
                                </tr>
                              <?php $i++;} ?>
                                </tbody>
                            </table>
