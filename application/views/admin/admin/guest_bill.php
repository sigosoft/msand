                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Guest Bill</h4>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Guest Bill</h4></span>
                                            </h2>


                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/guest/do_add" method="post" onsubmit="return show_guest_balance();">
                                                          ...
                                                          <!--<div class="form-group m-b-25 clearfix">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                      ...
                                                                      <div class="col-12 fl">
                                                                          ...
                                                                          <input type="text" class="form-control"   name="customer"  id="customer"   onclick="show_customer();">
                                                                      </div>
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                          ...
                                                                          <div class="col-3 fl mt30">
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/main_admin/add_vehicle_guest"><button class="btn btn-info" value="Add New" type="button">Add New</button></a>
                                                                          </div>
                                                                          <div class="col-3 fl mt30">
                                                                      ...
                                                                      <div class="form-group m-b-25 clearfix">
                                                                              ...
                                                                              <!--  <select class="form-control" id="product" name="product" onchange="show_price();">
                                                                                ...
                                                                                <select class="form-control" id="product" name="product" required onchange="show_price();">
                                                                              ...
                                                                              <div class="col-12 fl">
                                                                                  ...
                                                                                  <input type="hidden" class="form-control"   name="rate" id="rate" required readonly>
                                                                              </div>
                                                                          ...
                                                                          <div class="form-group m-b-25 clearfix">
                                                                                  ...
                                                                                  <div class="col-12 fl">
                                                                                    <label for="notes" ><b>Quantity</show_priceb></label>

                                                                                  <input type="text" class="form-control"   name="qty" id="qty" required oninput="calc_total();" >
                                                                                      </div>
                                                                              </div>
                                                                              ...
                                                                              <div class="form-group m-b-25 clearfix">
                                                                                  ...
                                                                                  <div class="col-12 fl">
                                                                                    <label for="notes" ><b>Rate</b></label>

                                                                                  <input type="text" class="form-control"    name="price" id="price" required oninput="calc_total();" >
                                                                                      </div>
                                                                              </div>
                                                                              ...
                                                                              <div class="form-group m-b-25 clearfix">
                                                                                      ...
                                                                                      <div class="col-12 fl">
                                                                                        <label for="notes" ><b>Total</b></label>

                                                                                      <input type="text" class="form-control"   name="total" id="total" required  onchange="cal_discount();" readonly>
                                                                                          </div>
                                                                                  </div>
                                                                                  ...
                                                                                  <div class="form-group m-b-25 clearfix">
                                                                                          ...
                                                                                          <div class="col-6 fl">
                                                                                            <label for="notes" ><b>Discount</b></label>

                                                                                          <input type="text" class="form-control"   name="discount" id="discount"   oninput="show_amount();">
                                                                                              </div>
                                                                                              <div class="col-6 fl">
                                                                                      ...
                                                                                      <div class="form-group m-b-25 clearfix">
                                                                                              <div class="col-12 fl">
                                                                                                <label for="notes" ><b>Cash Recieved</b></label>
                                                                                                <input type="number" class="form-control"   name="cash_recieved" id="cash_recieved" required oninput="show_bal_amount();" min=1>
                                                                                              </div>
                                                                                      </div>
                                                                                      ...
                                                                                      <div class="form-group m-b-25 clearfix">
                                                                                              ...
                                                                                              <input type="text" class="form-control"   name="balance" id="balance1" required readonly>
                                                                                                  </div>
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/main_admin/guest"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
...
//alert(a.value);
    eid = a.value;
    $.ajax({
    url: '<?php echo base_url();?>index.php/main_admin/view_product_details1/'+eid,
    type:'POST',
...
function show_balance(){
  var bal = document.getElementById("customer").value;
  //alert(bal);
  $.ajax({
          method: "POST",
...
function show_price(){
  var product = document.getElementById("product").value;
   ...
   $.ajax({url: '<?php echo base_url(); ?>index.php/main_admin/show_guest_product_price/'+product, success: function(result){
...
function show_amount(){
  ...
  var perc = (total*1)/100;
  if(discount>perc ){
    //alert("Discount is not between 1%");
    document.getElementById("discount").value=0;
    document.getElementById("amount").value=0;
  }
  else{
    var amount = (parseFloat(total)-parseFloat(discount));
...
function show_guest_balance(){
  var cash = document.getElementById("cash_recieved").value;
