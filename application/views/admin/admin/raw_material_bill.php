...
<style>
  ...
  .mt30{
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Raw Material Bill</h4>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/raw_material/do_add" method="post" onsubmit="return vehicle_alert();">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                          ...
                                                                          <div class="col-12 fl">
                                                                              ...
                                                                              <select class="form-control selectpicker " data-live-search="true" rows="5" name="reg_no" onchange="show_details(this)" id="reg" onclick="show_items();" required>
                                                                      ...
                                                                      <div class="form-group m-b-25 clearfix">
                                                                              ...
                                                                              <!--  <select class="form-control" id="product" name="product" onchange="show_price();">
                                                                                ...
                                                                                <?php $vendor = $this->session->userdata('vendor_id'); ?>
                                                                                <select class="form-control" id="product" name="product" onchange="show_price();" >
                                                                                  <option value="0">Select product</option>
                                                                                  <?php $res = $this->db->get('raw_material')->result_array();
                                                                                  //$res =$this->db->query("SELECT raw_material.*,vendor_products.* FROM raw_material INNER JOIN vendor_products ON raw_material.raw_material_id=vendor_products.name WHERE vendor_products.vendor_id='$vendor'")->result_array();
                                                                              ...
                                                                              <div class="col-4 fl">
                                                                                  ...
                                                                                  <input type="text" class="form-control" data-toggle="password"  name="price" id="price" required oninput="calc_total();">
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/main_admin/raw_material"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
        ...
        <script src="<?php echo base_url(); ?>assets/bootstrap-show-password.min"></script>
...
function show_balance(){
  ...
  //alert(id);
        ...
        $.ajax({url: '<?php echo base_url(); ?>index.php/main_admin/getPrices_vendor_products/'+cust_id, success: function(result){
...
function show_price(){
  ...
  $.ajax({url: '<?php echo base_url(); ?>index.php/main_admin/get_vendor_product/'+product+'/'+id, success: function(result){
