                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Vendor Report</h4>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/vendor_report/show_report" method="post">
                                                    ...
                                                    <div class="form-group m-b-25">
                                                            <div class="col-12">
                                                                ...
                                                                <select class="form-control" rows="5" name="customer">
                                                                  ...
                                                                  <?php $res=$this->db->get_where('vendor')->result_array();
                                                                        foreach($res as $res1){
                                                                   ?>
                                                                  <option value="<?php echo $res1['vendor_id']; ?>"><?php echo $res1['name']; ?></option>
                                                                <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                              ...
                              <b>Customer : <?php echo $customer; ?></b><br><br>
                                ...
                                <thead>
                                    <tr><td colspan="10">
                                  <?php  $sq="SELECT `balance` FROM `ledger` WHERE `Transdate`='$from' and `SupplierID`='$customer1' order by LedgerID asc limit 1";
                                  $res111=$this->db->query($sq)->result_array();  
                                  
                                  if($res111==NULL){
                                      $sq2="SELECT `balance` FROM `ledger` WHERE `Transdate`>'$from' and `SupplierID`='$customer1' order by LedgerID asc limit 1";
                                      ...
                                      $sq1="SELECT `ob` FROM `vendor` WHERE `vendor_id`='$customer1'";
                            ...
                            <tr><td colspan="10">
                                ...
                                <?php  $sq="SELECT `balance` FROM `ledger` WHERE `Transdate`>'$to' and `SupplierID`='$customer1' order by LedgerID asc limit 1";
                                  $res111=$this->db->query($sq)->result_array();  
                                  
                                  if($res111==NULL){
                                      $sq1="SELECT `balance` FROM `debitor` WHERE `vendor_id`='$customer1'";
                                      $res11=$this->db->query($sq1)->result_array(); 
