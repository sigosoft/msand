                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Purchase Balance</h4>
...
<!-- /.modal-dialog -->
                        ...
                        <div class="row">
                            <div class="col-12">
                              <?php
                              ?>
                              <!--<b>TOTAL PURCHASE</b> :<?php echo $amount; ?><br><br>-->
                              <b>DATE</b>:  <?php echo date('d-M-Y'); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $this->db->get_where('vendor',array('vendor_id'=>$row['product']))->row()->name; ?></td>
