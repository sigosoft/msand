	...
	<section>
		...
		<section class="pt30 pb30">
			<div class="container" >
				<div class="row">
					<div class="col-12">
            <?php $res = $this->db->get_where('guest_print',array('guest_print_id'=>$id))->result_array();
                  foreach($res as $row){
            ?>
						<p class="col-4">No</p> <p class="col-3">:</p><p class="col-4"><strong><?php echo $row['guest_invoice_no']; ?></strong></p>
            ...
            <p class="col-4">Item</p> <p class="col-3">:</p> <p class="col-4"><strong><?php  echo $this->db->get_where('product',array('id'=>$row['product']))->row()->name;  ?></strong></p>
            <p class="col-4"></p> <p class="col-3"></p> <p class="col-4"><strong><?php echo $row['quantity'];  ?></strong></p>
            <p class="col-4">Total</p> <p class="col-3">:</p> <p class="col-4"><strong><?php echo $row['cash_recieved'];  ?></strong></p>
...
<section class="pt30 pb30 border1"></section>
  ...
  window.print();
  window.location.href = "<?php echo base_url(); ?>index.php/main_admin/guest";
   }
