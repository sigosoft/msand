                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Vendors Details</h4>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Edit Vendors</h4></span>
                                            </h2>

<?php foreach($vendor as $row) { ?>
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/vendor/update/<?php echo $row['vendor_id']; ?>" method="post">
                                              <div class="form-group m-b-25 clearfix">
                                                <div class="col-12">
                                                      ...
                                                      <div class="col-6 fl">
                                                        ...
                                                        <input type="text" class="form-control" rows="5" name="mobile" required value="<?php echo $row['mobile']; ?>">
                                                      </div>

                                                     <div class="col-6 fl">
                                                        <label for="notes">Amount</label>

                                                        <input type="text" class="form-control" rows="5" name="amount" value="<?php echo $row['ob']; ?>">
                                                      </div>
                                                      </div>
