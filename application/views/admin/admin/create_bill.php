                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Bill</h4>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/bill/do_add" method="post" onsubmit="return vehicle_alert();">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                          ...
                                                                          <div class="col-3 fl mt30">
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/main_admin/add_vehicle"><button class="btn btn-info" value="Add New" type="button">Add New</button></a>
                                                                          </div>
                                        <div class="col-3 fl mt30">
...
function show_balance(){
  ...
  /*$.ajax({
        ...
        $.ajax({url: '<?php echo base_url(); ?>index.php/main_admin/show_customer_balance/'+cust_id, success: function(result){
...
function show_price(){
  ...
  var customer = document.getElementById("customer").value;
   ...
   $.ajax({url: '<?php echo base_url(); ?>index.php/main_admin/show_product_price/'+product+'/'+customer, success: function(result){
