                    ...
                    <div class="container-fluid">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/main_admin/sales_report/show_report" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                              ...
                              <tr><td colspan="6"><td><?php echo $this->db->get_where('product',array('id'=>$res['product']))->row()->name; ?></td>
