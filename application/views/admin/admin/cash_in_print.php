...
<body onload="test()">
	<section>
		...
		<section class="pt30 pb30">
			<div class="container" >
				<div class="row">
					<div class="col-12">
            <?php $res = $this->db->get_where('cash_in',array('cash_in_id'=>$id))->result_array();
                  foreach($res as $row){
            ?>
						<p class="col-4">No</p> <p class="col-3">:</p><p class="col-4"><strong><?php echo $row['cash_in_invoice']; ?></strong></p>
  ...
  window.print();
  window.location.href = "<?php echo base_url(); ?>index.php/main_admin/cash_in";
}
