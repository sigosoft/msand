                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h2 class="text-uppercase text-center m-b-30">
                                                <span><h4>Raw Material Bill</h4></span>
                                            </h2>


                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/account/raw_material/do_add" method="post" onsubmit="return vehicle_alert();">
                                                          ...
                                                          <!--<div class="form-group m-b-25 clearfix">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                      ...
                                                                      <div class="col-12 fl">
                                                                          ...
                                                                          <input type="hidden" class="form-control"  name="balance" id="balance" required  >
                                                                      </div>
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                      ...
                                                                      <div class="form-group m-b-25 clearfix">
                                                                              ...
                                                                              <div class="col-12 fl">
                                                                                  ...
                                                                                  <input type="hidden" class="form-control" data-toggle="password"  name="price" id="price" required oninput="calc_total();">
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/account/raw_material"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
...
function show_price(){
  ...
  $.ajax({url: '<?php echo base_url(); ?>index.php/account/get_vendor_product/'+product+'/'+id, success: function(result){
