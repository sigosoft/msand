                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/account/Cash_report/close_account" method="post">
...
$res=$this->db->get_where('cash_in',array('date'=>$d));
$data1= $res->row();
$cash_in =  $data1->amount;

$this->db->select_sum('amount');
$res=$this->db->get_where('cash_out',array('date'=>$d));
$data2= $res->row();
