                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                      <div class="modal-body">
                                           ...
                                           <div id="vend1" >
                                           <form class="form-horizontal " action="<?php echo base_url(); ?>index.php/Account/cash_out/vendor_do_add" method="post">
                                            ...
                                            <div class="form-group m-b-25 clearfix "  >
                                                ...
                                                <form class="form-horizontal " action="<?php echo base_url(); ?>index.php/Account/cash_out/customer_do_add" method="post">
