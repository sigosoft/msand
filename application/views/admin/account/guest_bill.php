                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/account/guest/do_add" method="post" onsubmit="return show_guest_balance();">
                                                              ...
                                                              <div class="form-group m-b-25 clearfix">
                                                                  ...
                                                                  <div class="form-group m-b-25 clearfix">
                                                                          ...
                                                                          <!--<div class="col-3 fl mt30">
                                                                              ...
                                                                              <a href="<?php echo base_url(); ?>index.php/account/add_vehicle_guest"><button class="btn btn-info" value="Add New" type="button">Add New</button></a>
                                                                          </div>-->
                                                                          <div class="col-3 fl mt30">
                                                ...
                                                <div class="form-group account-btn text-center m-t-10">
                                                    <div class="col-12">
														<a href="<?php echo base_url(); ?>index.php/account/guest"><button type="button" class="btn w-lg btn-rounded btn-light waves-effect m-l-5" >Back</button></a>
...
function show_price(){
  var product = document.getElementById("product").value;
   ...
   $.ajax({url: '<?php echo base_url(); ?>index.php/account/show_guest_product_price/'+product, success: function(result){
